...
const state = {
  ...
  drill: { level: "month", monthKey: null, dayKey: null, hourKey: null },
...
document.addEventListener("click", async (e) => {
  ...
  switch (action) {
    ...
    case "nav":
      ...
      state.drill = { level: "month", monthKey: null, dayKey: null, hourKey: null };
      await renderApp();
      break;
    ...
    case "drill-back":
      if (state.drill.level === "hour" && state.drill.hourKey) {
        state.drill = { level: "hour", monthKey: state.drill.monthKey, dayKey: state.drill.dayKey, hourKey: null };
      } else if (state.drill.level === "hour") {
        state.drill = { level: "day", monthKey: state.drill.monthKey, dayKey: null, hourKey: null };
